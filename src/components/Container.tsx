...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "Sai Ritesh",
    description: `A motivated Computer Science student passionate about web development, exploring technologies like Next.js, React, and Tailwind CSS.`,
  ...
  return (
    <>
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">Sai Ritesh</span>
        </Link>
              ...
              <div className="flex h-full flex-col items-start justify-between overflow-y-auto">
                ...
                <div className="flex min-h-fit w-full flex-col space-y-8 px-[22px] py-10">
                  <span className="text-sm text-muted-foreground">
                    © {new Date().getFullYear()} Sai Ritesh. All rights reserved.
                  </span>
                </div>
              </div>
            </motion.div>
